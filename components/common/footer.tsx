      ...
      <div className="container mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-sm text-neutral-600 leading-relaxed max-w-sm">
              The UK's trusted source for wholesale packaging solutions. We
              provide businesses with high-quality, eco-conscious materials
              delivered next-day.
            </p>
        ...
        <div className="border-t border-neutral-200 mt-16 pt-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-neutral-500">
            <p>
              © {new Date().getFullYear()} Bubble Wrap Shop Ltd. All rights
              reserved.
            </p>
            <div className="flex gap-4">
