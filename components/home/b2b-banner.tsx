  ...
  return (
    <section className="w-full px-4 sm:px-6 lg:px-8 py-2">
      <div className="container mx-auto max-w-[1200px]">
        <div className="relative overflow-hidden rounded-lg border border-white/20 bg-red-600/95 backdrop-blur-xl shadow-md transition-all duration-300 hover:shadow-red-500/25 group">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-3 p-3 sm:px-6">
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto text-center sm:text-left justify-center sm:justify-start">
              ...
              <div>
                ...
                <p className="text-red-50 text-[10px] sm:text-xs font-medium">
                  ...
                  <span className="text-white font-bold underline decoration-white/30 underline-offset-2">
                    40% on packaging
                  </span>
                  .
                </p>
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto justify-center sm:justify-end">
              <button
                ...
                title="Learn about our B2B wholesale program"
              >
                Learn More
              </button>

              <Button asChild variant="secondary" className="text-xs sm:text-sm rounded-md px-3 py-1.5 sm:px-4 sm:py-2 text-black">
                <Link href="/wholesale" title="Submit a wholesale inquiry">
                  Submit Request
                  <Send className="..." />
                </Link>
              </Button>
