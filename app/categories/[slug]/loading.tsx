    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="py-10 md:py-16 lg:py-20">
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
              ...
              <div className="flex-1 text-center lg:text-left">
                <div className="inline-flex h-8 w-40 bg-white/10 rounded-full mb-4 animate-pulse" />
                <div className="h-14 md:h-16 lg:h-20 w-full max-w-md bg-white/20 rounded-lg mb-4 mx-auto lg:mx-0 animate-pulse" />
                <div className="h-6 w-full max-w-lg bg-white/10 rounded mb-2 mx-auto lg:mx-0 animate-pulse" />
                <div className="h-6 w-3/4 max-w-md bg-white/10 rounded mb-6 mx-auto lg:mx-0 animate-pulse" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl py-12 md:py-16">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="hidden md:block h-5 w-32 bg-muted/50 rounded animate-pulse" />
        </div>
          ...
          {Array.from({ length: 8 }).map((_, i) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="h-3 w-1/2 bg-muted/50 rounded mb-3 animate-pulse" />
      ...
      <div className="bg-gradient-to-b from-secondary/30 to-background py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-center mb-12">
            <div className="h-8 w-72 bg-muted rounded mx-auto mb-3 animate-pulse" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="space-y-4">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="bg-secondary/30 rounded-xl border border-border p-5"
              >
      ...
      <div className="py-16 md:py-20 bg-gradient-to-r from-emerald-600 to-teal-600">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-center">
          <div className="h-8 w-64 bg-white/10 rounded-full mx-auto mb-4 animate-pulse" />
          <div className="h-10 w-80 max-w-full bg-white/20 rounded mx-auto mb-4 animate-pulse" />
